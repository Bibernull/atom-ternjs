...
export default class PackageConfig {
  ...
  constructor(manager) {
    ...
    this.options = {
      ...
      snippetTypeHints: atom.config.get('atom-ternjs.snippetTypeHints'),
    };
  ...
  registerEvents() {
    ...
    this.disposables.push(atom.config.observe('atom-ternjs.snippetTypeHints', (value) => {

      this.options.snippetTypeHints = value;
    }));
  }
